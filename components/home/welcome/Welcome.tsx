...
const Welcome = () => {
  return (
    <section className="pt-36 lg:pt-52 overflow-hidden">
      <div className="md:container mx-auto px-2.5">
        <div className="mb-28 py-9 px-5 lg:px-[84px] lg:py-16 relative text-white rounded-[30px] md:rounded-3xl bg-purple-dark-400">
          <div className="relative z-10">
            ...
            >
              ...
              <span className="relative leading-none">
                <span className="text-xs lg:text-sm tracking-[0.3px] group-hover:opacity-0 transition-opacity block">
                  <span className="lg:mr-2">Need some help?</span>
                  <span className="font-bold">Join our discord</span>
                </span>

                <span className="text-xs lg:text-sm tracking-[0.3px] left-0 bg-gradient-purple-100 bg-clip-text webkit-text-fill-color-transparent opacity-0 group-hover:opacity-100 transition-opacity absolute bottom-0 top-0">
                  <span className="lg:mr-2">Need some help?</span>
                  <span className="font-bold">Join our discord</span>
                </span>
              </span>
